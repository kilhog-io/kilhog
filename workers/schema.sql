-- Optional bootstrap schema for Cloudflare D1.
-- Prefer letting the worker apply embedded SQLite migrations at startup
-- (KILHOG_AUTO_MIGRATE=true). Use this file only for manual wrangler d1 execute.

-- +kilhog dialect: sqlite (D1)
