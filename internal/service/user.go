...
var (
	...
	ErrMachinePoolNotFound        = errors.New("machine pool not found")
	ErrMachinePoolNameTaken       = errors.New("machine pool name already exists")
	ErrMachinePoolSlugTaken       = errors.New("machine pool slug already exists")
	ErrInvalidMachinePool         = errors.New("invalid machine pool")
	ErrMachineProviderNotFound    = errors.New("machine identity provider not found")
	ErrMachineProviderNameTaken   = errors.New("machine identity provider name already exists")
	ErrMachineProviderIssuerTaken = errors.New("machine identity provider issuer already exists")
	ErrInvalidMachineProvider     = errors.New("invalid machine identity provider")
	ErrMachineNotFound            = errors.New("machine not found")
	ErrMachineNameTaken           = errors.New("machine name already exists")
	ErrInvalidMachine             = errors.New("invalid machine")
	ErrMachineAPIKeyNotFound      = errors.New("machine api key not found")
	ErrInvalidMachineAPIKey       = errors.New("invalid machine api key")
)
